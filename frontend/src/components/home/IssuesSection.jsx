...
const IssuesSection = () => (
  <section className="py-12 px-4 md:px-16 max-w-5xl mx-auto">
    <h2 className="text-3xl font-bold text-blue-300 mb-8 text-center">Most Reported Issues</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      {issues.map((issue) => (
        <div
          key={issue.title}
          className={`rounded-xl shadow-lg p-6 flex flex-col items-start ${issue.color} bg-opacity-80`}
        >
